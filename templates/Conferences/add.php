...
echo $this->Form->control('Tag', ['label'=>'Subject tags', 'after'=>'Arxiv subject areas.  Select one or more; type to narrow options', 'multiple'=>true, 'default'=>$tagids,'empty'=>false,'required']);
