...
<p>MathMeetings.net provides a list of conferences and similar meetings in mathematics. There are a number of other such lists, but this list aims to be more complete by allowing <em>anyone at all</em> to add announcements. This is similar in spirit to a wiki, but the announcements are formatted and stored in a database for efficient searching and sorting.</p>

<p>Announcements are filtered by subject tags, and are curated by <a href=#curators>the volunteers listed below</a>. <em>Note</em>: This site restricts itself to meetings whose focus is mathematics. Announcements about more general meetings are typically not appropriate and may be deleted.</p>

<p>The site is developed by <a href="https://nilesjohnson.net" target="blank">Niles Johnson</a>. It began as a list for conferences in topology, but with the addition of subject tags we hope that it will be useful more generally. Please <a href="https://nilesjohnson.net/contact.html" target="blank">contact Niles</a> if you have further quesitons or comments!</p>


<h2>Adding Announcements</h2>

<div>
<p> To add an announcement, use the link at the top of the page. An email address is required so that announcements you post can be edited or deleted. To prevent abuse, a security token is stored as a browser cookie. </p>
...
database.
 The subject tags are taken from the <a href="http://arxiv.org/archive/math">arXiv.org math
categories</a>.</p>

<p>The link to update tags on the home page is generated automatically by
javascript.
 If you prefer not to use javascript, you can easily create the
...
parsed by third-party software.
